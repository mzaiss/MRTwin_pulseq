...
xedit -f %IceConfigFile% -n ICE.CONFIG.OnlineSendConfiguration -p OnlineSendIMA -v "true"

xedit -f %IceConfigFile% -n ICE.CONFIG.OnlineSendConfiguration -p OnlineTargetPort -v -1

xedit -f %IceConfigFile% -n ICE.CONFIG.OnlineSendConfiguration -p OnlineTargetHostName -v 10.8.77.23

xedit -f %IceConfigFile% -n ICE.CONFIG.OnlineSendConfiguration -p SendBuffered -v "false"

xedit -f %IceConfigFile% -n ICE.CONFIG.OnlineSendConfiguration -p OnlineTargetPath -v "W:\AutoB0B1Transfer"