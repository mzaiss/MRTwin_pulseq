...
scanner = core.scanner.Scanner_fast(sz,NVox,NSpins,NRep,NEvnt,NCoils,noise_std,use_gpu+gpu_dev,double_precision=double_precision,do_voxel_rand_ramp_distr=do_voxel_rand_ramp_distr,do_voxel_rand_r2_distr=do_voxel_rand_r2_distr)
...
gradm_event[-2,:,1] = 1.5* sz[0]
#gradm_event[-2,:,1] = 0.2* sz[0]
