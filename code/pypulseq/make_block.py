...
def make_block_pulse(kwargs, nargout=1):
    ...
    # !!!!!!!!!!! TODO
    rf.delay = 0  # we have to set it to zero. bug in pulseq? matlab-python pulseq mismatch
...
#        rf.signal = np.reshape(rf.signal, (1, len(rf.signal)))
    ...
    # WARNING/ possibly bug in Pulseq -- crosscheck matlab/python
    if rf.ring_down_time > 0 and False:
