...
# forward/adjoint pass
scanner.forward_sparse_fast(spins, event_time,do_dummy_scans=False)  # do dummies
...
def init_variables():
    ...
    grad_moms[1,:,1] = torch.randn((scanner.NRep)) 
...
def phi_FRP_model(opt_params,aux_params):
    ...
    lbd = 0.1*1e1         # switch on of SAR cost
...
opt.custom_learning_rate = [0.01,0.0000000000000001,0.1,0.1]
...
#RF
print("step 1 RF")
opt.custom_learning_rate = [0.1,0.09,0.1,1e-12] # ADC, RF, time, grad
