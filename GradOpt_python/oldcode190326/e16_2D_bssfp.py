...
flips[0,0,0] = alpha/2  # SE preparation part 1 : 90 degree excitation
flips[0,1:,0] = alpha  # SE preparation part 1 : 90 degree excitation
...
grad_moms[0,:,0]  =  -grad_moms[2,:,0]     # bssfp: rewinder after 90 degree half length, half gradmom
grad_moms[-1,:,0]  = grad_moms[2,:,0]     # bssfp: rewinder after 90 degree half length, half gradmom
grad_moms[-1,:,1]  = -grad_moms[-2,:,1]     # bssfp: rewinder after 90 degree half length, half gradmom
#grad_moms[:,-1,:] = -grad_moms[:,0,:]/2    # bssfp: rewinder after 90 degree half length, half gradmom
...
opt.custom_learning_rate = [0.01,0.01,0.0001,0.01]
