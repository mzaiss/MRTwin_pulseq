...
rf0, _,_ = make_sinc_pulse(flip_angle=15/2 * math.pi / 180, duration=1e-3,slice_thickness=slice_thickness, apodization=0.5, time_bw_product=4, system=system)
seq.add_block(rf0)
...
# % compare with original phantom PD
