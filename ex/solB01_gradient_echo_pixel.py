...
# or (ii) set phantom  manually to a pixel phantom
    ...
    obj_p[32,60,:]=torch.tensor([1, 1, 0.1, 30e-3, 0, 1]) # dimensions: PD, T1 T2, T2dash, dB0 rB1
    
    # obj_p[40,60,:]=torch.tensor([0.25, 1, 0.1, 30e-3, 0, 1]) # dimensions: PD, T1 T2, T2dash, dB0 rB1
