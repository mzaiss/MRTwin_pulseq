...
gx_ = make_trapezoid(channel='x', flat_area=-Nread, flat_time=4e-3, system=system)
adc = make_adc(num_samples=Nread, duration=4e-3, phase_offset=0*np.pi/180,delay=gx.rise_time, system=system)
gx_pre = make_trapezoid(channel='x', area=-gx.area / 2, duration=2e-3, system=system)
gy_pre = make_trapezoid(channel='y', area=-Nphase//2, duration=2e-3, system=system)

gp= make_trapezoid(channel='y', area=1, duration=2e-3, system=system)
# ======
# CONSTRUCT SEQUENCE
# ======
