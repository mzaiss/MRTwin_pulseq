...
experiment_id = 'tgtFLASHSS_tskFLASH'
experiment_description = """
centric reordered, use dummies
"""
...
event_time[1,:] = 0.1*1e-3
event_time[-2,:] = 0.1*1e-3
event_time[-1,:] = 0.001         # GRE/FID specific, GRE relaxation time: choose large for fully relaxed  >=1, choose small for FLASH e.g 10ms
...
permvec = [8,7,9,6,10,5,11,4,12,3,13,2,14,1,15,0]   # centric reorder
grad_moms[1,:,1] = grad_moms[1,permvec,1]           # centric reorder
...
scanner.do_dummy_scans(spins,event_time,nrep=5)   # do dummies
# forward/adjoint pass
scanner.forward(spins, event_time,do_dummy_scans=True)  # do dummies
...
def phi_FRP_model(opt_params,aux_params):
    ...
    lbd = 0.0*1e1         # switch on of SAR cost
