...
experiment_list.append(["190615", "e25_opt_pitcher16_CLUSTERTEST", "e25_opt_pitcher_cluster_ready.py"])

while True:
    for exp in experiment_list:
        basepath = 'out'

        basepath = os.path.join(basepath, "seq" + exp[0])
        basepath = os.path.join(basepath, exp[1])
        
        fn_jobcontrol = "jobcontrol.txt"     
        job_def = '/home/aloktyus/condor_jobs/mrizero_tueb/send_job_bid.sh 2 ' + exp[2] + ' 16000 16000 0 0  > /dev/null'
