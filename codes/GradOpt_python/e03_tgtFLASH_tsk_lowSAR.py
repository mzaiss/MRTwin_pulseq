...
experiment_id = 'tgtFLASH_tsklowSAR'
experiment_description = """
tgt flashspoiled task low SAR
"""
...
event_time[1,:] = 1e-3
event_time[-2,:] = 1e-3
#event_time[-1,:] = 1e1           # GRE/FID specific, GRE relaxation time: choose large for fully relaxed  >=1, choose small for FLASH e.g 10ms
