...
fullpath_seq = r"\\141.67.249.47\MRTransfer\pulseq_zero\sequences\seq200528\q15_tgtT2_tskT2SEPrep_supervised_seqNNvivo_full"
...
iteration_idx = [0,*np.arange(50,8050,200)]
# iteration_idx.sort()
...
scanner = core.scanner.Scanner(sz,NVox,NSpins,NRep,T,NCoils,noise_std,use_gpu+gpu_dev,double_precision=double_precision,coilCombineMode='adaptive')
...
for n, iter_idx in enumerate(iteration_idx):
    ...
    TE_prep = torch.from_numpy(TE_preps[n])#+2e-03
