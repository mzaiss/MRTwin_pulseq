...
def cg_batch(A_bmm, B, M_bmm=None, X0=None, rtol=1e-3, atol=0., maxiter=None, verbose=False, callback=None):
    ...
    Args:
        ...
        callback: function that is called at each iteration, takes k, X_k and R_k (iter number, current value and residual)
    """
    K, n, m = B.shape
