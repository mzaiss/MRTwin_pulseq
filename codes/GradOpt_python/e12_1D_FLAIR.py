...
flips[0,:] = 180*np.pi/180  # FLAIR preparation part 1 : 90 degree excitation
flips[1,:] = 90*np.pi/180  # GRE preparation part 1 : 90 degree excitation
...
def init_variables():
    ...
    grad_moms[-1,:,:] = grad_moms[-2,:,:]  # differentiation requires this to avoid jump at end
