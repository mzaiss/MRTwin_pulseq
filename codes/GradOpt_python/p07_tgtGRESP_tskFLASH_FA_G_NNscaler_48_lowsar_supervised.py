...
experiment_id = 'p07_tgtGRESP_tskFLASH_FA_G_NNscaler_48_lowsar_supervised1px_adaptive'
...
if hostname == 'vaal' or hostname == 'madeira4' or hostname == 'gadgetron':
    ...
    opt.save_param_reco_history(experiment_id,today_datestr,sequence_class,generate_pulseq=False, adaptive_stopping=True)
