function seq = WriteEPISequenceWithPulseq(SeqOpts, seqFilename)
...
gx = mr.makeTrapezoid('x','FlatArea',Nx*deltak,'FlatTime',3.2e-3,'RiseTime', riseTime);
...
gxPre = mr.makeTrapezoid('x','Area',-gx.area/2,'Duration',3.2e-3, 'RiseTime', riseTime);
