...
function [phi,tdg,prediction,E,field,grads] = phi_grad_allrep_readout2d(g,m,rampX,rampY,adc_mask,sz,NRep,lambda,use_tanh_fieldcap)
...
for rep = 1:NRep
  ...
  grads{rep} = diff(cat(1,[0,0],field),1);                                     % actual gradient forms are the derivative of field (inverse cumsum)
